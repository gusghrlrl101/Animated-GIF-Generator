...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li class="active">
                <span style="color:#337ab7;padding: 10px 15px;display:block;">&lt;%&ndash;<i class="fa fa-folder-open-o fa-fw"></i>&ndash;%&gt; <strong>미디어 편집</strong>&lt;%&ndash;<span class="fa arrow"></span>&ndash;%&gt;</span>
            ...
            <%--</li>
                <li class="active">
                    <span style="color:#337ab7;padding: 10px 15px;display:block;">&lt;%&ndash;<i class="fa fa-folder-open-o fa-fw"></i>&ndash;%&gt; <strong>유틸리티 툴</strong>&lt;%&ndash;<span class="fa arrow"></span>&ndash;%&gt;</span>
                    <ul class="nav nav-second-level">
                        <li>
